...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 412.0, 128.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 364.0, 128.0, 22.0 ],
					"style" : "",
					"text" : "gen~ @gen SahSlicer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.5, 44.5, 330.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 14.0, 194.0, 47.0 ],
					"style" : "",
					"text" : "SahSlicer~"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 327.5, 14.0, 110.0, 20.0 ],
					"style" : "",
					"text" : "Controls"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 735.0, 73.5, 80.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 224.0, 456.0, 48.0, 136.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 319.5, 348.5, 45.0, 91.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.0, 256.0, 124.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 11.0, 383.5, 150.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 643.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 373.5, 348.5, 73.0, 33.0 ],
					"style" : "",
					"text" : "Turn audio on"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 574.0, 114.0, 94.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.5, 383.5, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 403.5, 94.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 6.0, 329.0, 150.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 898.0, 529.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "prepend Exp"
				}
...
, 						{
							"number" : 4,
							"data" : [ 5, "<invalid>", "dial", "float", 1.0, 5, "<invalid>", "dial", "float", 1.0, 5, "<invalid>", "dial", "float", 0.675, 5, "<invalid>", "dial", "float", 0.0, 5, "<invalid>", "dial", "float", 0.0, 5, "<invalid>", "number~", "list", 0.0, 5, "obj-81", "toggle", "int", 1, 5, "obj-17", "dial", "float", 0.61549, 5, "obj-30", "dial", "float", 1.0, 5, "obj-29", "dial", "float", 0.866667, 5, "obj-28", "dial", "float", 1.0, 5, "obj-42", "slider", "float", 0.0 ]
						}
 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 709.0, 44.5, 62.0, 22.0 ],
					"style" : "",
					"text" : "loadmess"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 262.0, 45.0, 23.0 ],
					"style" : "",
					"text" : "Exp"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 271.0, 187.0, 15.0, 75.0 ],
					"size" : 1.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.5, 219.0, 53.0, 23.0 ],
					"style" : "",
					"text" : "Push"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 267.0, 150.0, 23.0, 23.0 ],
					"style" : "",
					"text" : "D"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 193.0, 150.0, 24.0, 23.0 ],
					"style" : "",
					"text" : "C"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 116.0, 150.0, 24.0, 23.0 ],
					"style" : "",
					"text" : "B"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 150.0, 22.0, 23.0 ],
					"style" : "",
					"text" : "A"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 246.0, 102.0, 60.0, 60.0 ],
					"size" : 1.0,
					"style" : "",
					"thickness" : 100.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 172.0, 102.0, 60.0, 60.0 ],
					"size" : 1.0,
					"style" : "",
					"thickness" : 100.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 102.0, 60.0, 60.0 ],
					"size" : 1.0,
					"style" : "",
					"thickness" : 100.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 134.5, 172.0, 59.0, 59.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 102.0, 60.0, 60.0 ],
					"size" : 1.0,
					"style" : "",
					"thickness" : 100.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 67.0, 306.0, 218.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 709.0, 82.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 709.5, 119.5, 172.0, 22.0 ],
					"style" : "",
					"text" : "gate"
				}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 180.5, 340.0, 126.5, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 709.5, 147.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "s fakeCV"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 826.5, 33.5, 35.0, 22.0 ],
					"style" : "",
					"text" : "+~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 372.5, 156.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 326.0, 119.0, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 326.0, 97.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "D - reverse"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 326.0, 76.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "C - slices"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 326.0, 53.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "B - dry / wet"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 326.0, 31.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "A - slice input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 261.0, 70.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 417.5, 70.0, 22.0 ],
					"style" : "",
					"text" : "exportcode"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 625.5, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 373.5, 383.0, 56.5, 56.5 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.5, 5.5, 544.75, 192.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 319.0, 9.0, 127.0, 130.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 9.0, 307.0, 52.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -2.0, 319.5, 162.0, 127.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.25, 205.5, 549.5, 478.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 319.5, 338.0, 127.0, 112.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 699.5, 5.5, 226.0, 169.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 319.0, 141.5, 127.0, 181.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 569.0, 5.5, 122.0, 169.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 172.0, 323.5, 139.0, 127.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 63.0, 307.0, 222.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.5, -13.0, 1125.5, 713.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -2.0, 0.0, 458.5, 460.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				...
				"patcherrelativepath" : "../../SimpleFM/media",
				"type" : "PNG ",
				"implicit" : 1
			}
, 			{
				"name" : "SahSlicer.gendsp",
				"bootpath" : "~/Music/RebelTechnology/OwlGenPatches/SahSlicer/code",
